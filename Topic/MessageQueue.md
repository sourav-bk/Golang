...
It acts as a "middleman / middleware" that receives Data/messages from producers and routes them to consumers, storing messages in a queue until they are processed, ensuring reliable delivery and asynchronous communication.
