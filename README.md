...
<details><summary><h3><mark>Closure | Interfaces | Generic</summary></mark></h3>
  ...
  - ##### Interfaces :
    ...
    In Go, an interface is a collection of method signatures.., that defines the behavior of an object. It acts as a contract., that type must ful-fill by implementing all the methods., which declared in the interface.
